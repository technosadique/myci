										...
										<div style="" id="error_message_2"></div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input class="form-control" type="text" placeholder="Enter First Name" data-original-title="" id="first_name" name="first_name">
													...
													<div class="row">
														...
														<div class="form-group">
															...
															<div class="input-group">
																<input class="form-control" type="text" placeholder="Enter Last Name" data-original-title="" id="last_name" name="last_name">                                                                    
															</div>
													...
													<div class="row">
														...
														<div class="form-group">
															...
															<div class="input-group">
																<input class="form-control" type="text" placeholder="Enter Phone" data-original-title="" id="phone" name="phone">																	
...
<script src="<?php echo base_url();?>/public/assets/js/customer-add.js"></script>
<script>
